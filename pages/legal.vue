  ...
  <div class="body">
    <div class="container">
      ...
      <ul>
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named NPM
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Northern Property
            Management , 5293 Hidden Glen Dr .
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        copyright agent via email at austin@npm97.com and include in Your notice
      ...
      <p>
        You can contact our copyright agent via email at austin@npm97.com. Upon
      ...
      <ul>
        <li><a href="mailto:admin@technogym.com"> admin@technogym.com</a></li>
      </ul>
    </div>
  </div>
</template>
...
export default {
  head() {
    return {
      title: 'Technogym | Terms and conditions'
    }
  }
}
</script>
